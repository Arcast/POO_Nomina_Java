...
public class jd_EliminarEmpleado extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnCancelarEliminarE.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cancelar.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eliminar Emp.png"))); // NOI18N
...
public void ValidarEmpleado() {
    try {
        ...
        for (Empleado emp : empleados) {
            if (emp.getIdEmpleado().equalsIgnoreCase(_empleado)) {
                existe = true;
                break;
            }
        }
...
public void EliminarUsuario() {
    try {
        String _empleado = txtID.getText();
